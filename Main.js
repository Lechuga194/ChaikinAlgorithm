...
//Orejas
curva(ctx, 320, 150, 250, 67, 96, 800, 400, 700);
curva(ctx, 450, 150, 524, 77, 680, 800, 400, 700);
curva(ctx, 450, 150, 430, 170, 350, 175, 320, 150);

// //Ojos
curva(ctx, 270, 270, 290, 240, 326, 287, 270, 270);
curva(ctx, 470, 270, 500, 240, 526, 287, 470, 270);

//Nariz
curva(ctx, 397, 282, 422, 260, 372, 258, 397, 282);
curva(ctx, 397, 282, 414, 307, 440, 280, 440, 280);
curva(ctx, 397, 282, 374, 307, 355, 280, 355, 280);

//Bigotes
curva(ctx, 500, 300, 530, 300, 580, 280, 600, 280);
curva(ctx, 500, 320, 530, 320, 580, 300, 600, 300);
curva(ctx, 270, 300, 240, 300, 210, 290, 175, 285);
curva(ctx, 270, 320, 240, 320, 210, 310, 175, 305);

//Pancita
curva(ctx, 511, 600, 502, 544, 453, 479, 396, 480);
curva(ctx, 273, 600, 280, 544, 328, 479, 396, 480);
